...
Este projeto explora a intersecção entre criatividade humana e Inteligência Artificial. Utilizando técnicas de **RAG (Retrieval-Augmented Generation)** através do Gemini Gems, foi criado um assistente especializado na análise lírica de Linkin Park. O objetivo final foi a produção de um EP com 5 faixas inéditas, cujas letras foram geradas pela IA e a produção musical realizada via Suno AI.
...
> [Link para o meu Gemini Gems](https://gemini.google.com/gem/20081dc7967a)
...
---
Desenvolvido por [[Matheus Cardoso]](https://github.com/mtscardoso)
